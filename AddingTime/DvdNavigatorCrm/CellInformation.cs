...
namespace DvdNavigatorCrm
{
    ...
    public class CellInformation
    {
        ...
        public override string ToString()
        {
            ...
            sb.AppendFormat("PlaybackTime {0:f2} FPS {1}\n",
                this.playbackTime, this.fps);

            sb.AppendFormat("1stVob {0:X8} IlvuEnd {1:X8} LastVobStart {2:X8} LastVobEnd {3:X8}\n",
                this.firstVobuStartSector, this.firstIlvuEndSector,
                this.lastVobuStartSector, this.lastVobuEndSector);

            sb.AppendFormat("VobId {0} CellId {1}\n", this.vobId, this.cellId);
